...
- próximas fases:
  `v11.31.7` (core residual: render modal, funções de suporte, estabilização final) — `kc-create-post.js` de `1260L` → meta <700L.
