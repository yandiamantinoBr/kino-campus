...
- `v12.3.0`: `README.md`, `RELATORIO-KINOCAMPUS-V12.md` e `CHANGELOG.md` atualizados para marcar a auditoria do admin como concluida, corrigir o baseline do hotspot de `2251L` para `2034L` e apontar `v12.3.1` como proxima iteracao.
