...
(function () {
  ...
  const CARONAS_LOCATION_DEFINITIONS = Object.freeze([
    ...
    Object.freeze({ key: 'campus-jatai', label: 'Câmpus Jataí (UFJ)', icon: 'fas fa-university', zoneKey: 'campus-jatai', zoneLabel: 'Câmpus Jataí', isCampus: true, aliases: Object.freeze(['campus jataí','campus jatai','jataí','jatai','ufj']), abbreviations: Object.freeze(['UFJ']) }),
    Object.freeze({ key: 'campus-catalao', label: 'Câmpus Catalão (UFCAT)', icon: 'fas fa-university', zoneKey: 'campus-catalao', zoneLabel: 'Câmpus Catalão', isCampus: true, aliases: Object.freeze(['campus catalão','campus catalao','catalão','catalao','ufcat']), abbreviations: Object.freeze(['UFCAT']) }),
    // Unidades UFG
