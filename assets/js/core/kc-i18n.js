...
(function () {
  ...
  var _dict = {
    ...
    'meta-title.chat':                 'Mensagens - KinoCampus',
    ...
    'meta-title.admin-cadu':           'KinoCampus - Cadu Admin',
    ...
    'meta-description.chat':                'Mensagens diretas do KinoCampus para conversas entre usuários da comunidade universitária da UFG.',
    ...
    'meta-description.admin-cadu':          'Painel administrativo do Cadu para fontes UFG, feed coletado, pipeline e integração OpenClaw.',
    ...
    'aria-label.logo-home':             'Ir para o início',
    ...
    'aria-label.chat-delete-conv':      'Excluir conversa',
    'aria-label.chat-emoji':            'Escolher emoji',
    'aria-label.chat-emojis':           'Lista de emojis',
    ...
    'aria-label.cadu-sites-legend':     'Legenda de prioridades do Mapa UFG',
    'aria-label.cadu-sites-page-size':  'Itens por página no Mapa UFG',
    'aria-label.cadu-sites-page-prev':  'Página anterior',
    'aria-label.cadu-sites-page-next':  'Próxima página',
    'aria-label.cadu-review-queue-pagination': 'Paginação da fila editorial',
    ...
    'tooltip.cadu-kpi-sites':           'Abrir aba Sites UFG (lista completa)',
    'tooltip.cadu-kpi-instagram':       'Abrir aba Sites UFG filtrando por IG confirmado',
    'tooltip.cadu-kpi-tier1':           'Abrir aba Sites UFG filtrando por Tier 1',
    'tooltip.cadu-kpi-feed':            'Abrir aba Feed Coletado (memória do Cadu)',
    'tooltip.cadu-kpi-api':             'Status do cadu-api (FastAPI sidecar) — somente leitura',
    'tooltip.cadu-sites-export-pdf':    'Exportar mapa de sites em PDF (com KPIs + tabela filtrada)',
    ...
    'aria-label.admin-invite-link':         'Link de convite gerado',
    'aria-label.admin-invite-email':        'E-mail do convidado externo',
    'aria-label.admin-invite-reason':       'Motivo interno do convite',
    ...
    'placeholder.external-access-note': 'Registre uma observação interna; ela não será enviada ao solicitante.',
    ...
    'tooltip.chat-delete-conv':         'Excluir conversa',
    'tooltip.chat-emoji':               'Escolher emoji',
