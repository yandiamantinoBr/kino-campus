(function () {
  ...
  function initPlatformFooter() {
    ...
    footer.innerHTML = [
      ...
      '    <a class="kc-platform-footer__brand-mark" href="' + getRootHref('/') + '" aria-label="KinoCampus - página inicial">',
      ...
      '    <h2>Plataforma</h2>',
      '    <a href="' + getRootHref('/') + '">Início</a>',
      '    <a href="' + getRootHref('/sobre') + '">Sobre</a>',
      '    <a href="' + getRootHref('/meus-posts') + '">Minhas publicações</a>',
      '    <a href="' + getRootHref('/criar-post') + '">Criar publicação</a>',
      '  </nav>',
      '  <nav class="kc-platform-footer__column" aria-label="Módulos do KinoCampus">',
      '    <h2>Módulos</h2>',
      '    <a href="' + getRootHref('/achados-perdidos') + '">Achados e perdidos</a>',
      '    <a href="' + getRootHref('/eventos') + '">Eventos</a>',
      '    <a href="' + getRootHref('/moradia') + '">Moradia</a>',
      '    <a href="' + getRootHref('/oportunidades') + '">Oportunidades</a>',
      '    <a href="' + getRootHref('/compra-venda') + '">Compra e venda</a>',
      '    <a href="' + getRootHref('/caronas') + '">Caronas</a>',
      '  </nav>',
      '  <nav class="kc-platform-footer__column" aria-label="Suporte e conta">',
      '    <h2>Suporte</h2>',
      '    <a href="' + getRootHref('/ajuda') + '">Central de Ajuda</a>',
      '    <a href="' + getRootHref('/configuracoes') + '">Configurações</a>',
      '    <a href="' + getRootHref('/meus-posts') + '">Minhas publicações</a>',
      ...
      '    <h2>Transparência</h2>',
      '    <a href="' + getLegalHref('/transparencia') + '">Central de Transparência</a>',
      '    <a href="' + getRootHref('/editorial') + '">Política editorial</a>',
      ...
      '    <a href="' + getRootHref('/ajuda#solicitacoes-suporte') + '">Solicitações de suporte</a>',
      '  </nav>',
      '</div>',
      ...
      '    <a href="' + getRootHref('/ajuda') + '">Contato</a>',
      '    <a href="' + getLegalHref('/transparencia') + '">Transparência</a>',
      '    <a href="' + getLegalHref('/privacidade') + '">Privacidade</a>',
      '    <a href="' + getLegalHref('/termos') + '">Termos de Uso</a>',
  ...
  function buildMarkup() {
    ...
    root.innerHTML = [
      ...
      '      </label>',
      '      <p class="kc-consent-modal__note">Anúncios próprios contextuais podem aparecer sem rastrear seu perfil individual. Redes externas, como AdSense, só carregam com publicidade aceita. Veja a <a href="' + getLegalHref('/privacidade') + '">Declaração de Privacidade</a> e os <a href="' + getLegalHref('/termos') + '">Termos de Uso</a>.</p>',
      '    </div>',
