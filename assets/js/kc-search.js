...
async function loadDatabase() {
    try {
        if (KCAPI && typeof KCAPI.getDatabase === 'function') {
            kcDatabase = await KCAPI.getDatabase();
        } else {
...
function formatCurrencyBRL(value) {
    if (KCUtils && typeof KCUtils.formatCurrencyBRL === 'function') return KCUtils.formatCurrencyBRL(value);
    try {
