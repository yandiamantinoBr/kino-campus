/* KinoCampus - index controller (V8.1.2.4.5) */
(function () {
  'use strict';
  ...
  async function injectFeed() {
    try {
      ...
      try { console.debug(`[KCFeed:index] Carregando página ${PAGE} (${POSTS_LIMIT} posts)`); } catch (_) {}
      ...
      console.warn('[KinoCampus] Falha ao carregar feed dinâmico (index). Usando fallback estático.', e);
    }
  }
