...
const { ENV } = window.KCAPI;
  ...
  const driverSupabase = Object.freeze({
    ...
    createDataSubjectRequest: window._KCSA.admin.createDataSubjectRequest,
    listDataSubjectRequests: window._KCSA.admin.listDataSubjectRequests,
    getDataSubjectRequest: window._KCSA.admin.getDataSubjectRequest,
    downloadDataSubjectExport: window._KCSA.admin.downloadDataSubjectExport,
    downloadDataSubjectSupplement: window._KCSA.admin.downloadDataSubjectSupplement,
    cancelDataSubjectRequest: window._KCSA.admin.cancelDataSubjectRequest,
    processDataExportSupplement: window._KCSA.admin.processDataExportSupplement,
