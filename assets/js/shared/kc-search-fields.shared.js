...
(function (root, factory) {
  ...
  var FIELD_POLICIES = {
    ...
    data: policy('public-content', ['date-range'], ['metadata.data_evento', 'metadata.data', 'data'], false, true),
    data_fim: policy('public-content', ['date-range'], ['metadata.data_fim_evento', 'metadata.data_fim', 'data_fim'], false, true),
