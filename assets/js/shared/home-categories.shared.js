(function (root, factory) {
  ...
  const CATEGORY_CATALOG = Object.freeze([
    createEntry('compra-venda', 'eletronicos', 'Eletrônicos', 'fas fa-laptop', 'compra-venda-feed.html#eletronicos', ['eletronico', 'celular', 'notebook', 'tablet', 'fone']),
    createEntry('compra-venda', 'livros', 'Livros e Materiais', 'fas fa-book', 'compra-venda-feed.html#livros', ['livro', 'apostila', 'apostilas', 'materiais', 'material']),
    createEntry('compra-venda', 'ingressos', 'Ingressos', 'fas fa-ticket', 'compra-venda-feed.html#ingressos', ['ingresso', 'ticket', 'evento']),
    createEntry('compra-venda', 'moveis', 'Móveis', 'fas fa-couch', 'compra-venda-feed.html#moveis', ['movel', 'cadeira', 'mesa', 'armario', 'guarda-roupa']),
    createEntry('compra-venda', 'vestuario', 'Vestuário', 'fas fa-shirt', 'compra-venda-feed.html#vestuario', ['roupa', 'roupas', 'camisa', 'casaco', 'calca', 'calça']),
    createEntry('compra-venda', 'outros', 'Outros itens', 'fas fa-box-open', 'compra-venda-feed.html#outros', ['outro', 'diversos']),
    // Keys align with create-post schema + eventos.html (posts.category plural form).
    createEntry('eventos', 'academicos', 'Acadêmicos', 'fas fa-graduation-cap', 'eventos.html#academicos', ['academico', 'acadêmicos', 'semana academica', 'semana acadêmica']),
    createEntry('eventos', 'palestras', 'Palestras', 'fas fa-microphone-lines', 'eventos.html#palestras', ['palestra', 'mesa redonda', 'debate']),
    createEntry('eventos', 'congressos', 'Congressos', 'fas fa-users-rectangle', 'eventos.html#congressos', ['congresso', 'seminario', 'seminário', 'simposio', 'simpósio', 'jornada']),
    createEntry('eventos', 'cursos', 'Cursos', 'fas fa-book-open-reader', 'eventos.html#cursos', ['curso', 'minicurso', 'capacitacao', 'capacitação', 'formacao', 'formação']),
    createEntry('eventos', 'culturais', 'Culturais', 'fas fa-theater-masks', 'eventos.html#culturais', ['cultural', 'cultura', 'show', 'arte']),
    createEntry('eventos', 'esportivos', 'Esportivos', 'fas fa-running', 'eventos.html#esportivos', ['esportivo', 'esporte', 'corrida', 'torneio']),
    createEntry('eventos', 'workshops', 'Workshops', 'fas fa-chalkboard-teacher', 'eventos.html#workshops', ['workshop', 'oficina', 'tecnologia', 'hackathon', 'informatica', 'informática', 'computacao', 'computação']),
    createEntry('eventos', 'festas', 'Festas', 'fas fa-music', 'eventos.html#festas', ['festa', 'balada', 'show universitario', 'show universitário']),
    createEntry('eventos', 'sustentabilidade', 'Sustentabilidade', 'fas fa-leaf', 'eventos.html#sustentabilidade', ['sustentavel', 'sustentável', 'ambiental', 'eco', 'feira']),
    createEntry('moradia', 'republicas', 'Repúblicas', 'fas fa-users', 'moradia.html#republicas', ['republica', 'república', 'repúblicas']),
    createEntry('moradia', 'quartos', 'Quartos', 'fas fa-bed', 'moradia.html#quartos', ['quarto', 'dividir-quarto']),
    createEntry('moradia', 'apartamentos', 'Apartamentos', 'fas fa-building', 'moradia.html#apartamentos', ['apartamento', 'apto']),
    createEntry('moradia', 'casas', 'Casas', 'fas fa-house', 'moradia.html#casas', ['casa']),
    ...
    createEntry('oportunidades', 'editais', 'Editais e chamadas', 'fas fa-file-signature', 'oportunidades.html#editais', ['edital', 'chamada publica', 'chamada pública', 'mobilidade', 'intercambio', 'intercâmbio', 'internacional']),
    createEntry('oportunidades', 'concursos', 'Concursos e seleções', 'fas fa-clipboard-check', 'oportunidades.html#concursos', ['concurso', 'selecao', 'seleção', 'processo seletivo']),
    createEntry('oportunidades', 'bolsas', 'Bolsas', 'fas fa-award', 'oportunidades.html#bolsas', ['bolsa', 'auxilio', 'auxílio', 'fomento']),
    createEntry('oportunidades', 'estagios', 'Estágios', 'fas fa-user-graduate', 'oportunidades.html#estagios', ['estagio', 'bolsa-estagio']),
    createEntry('oportunidades', 'empregos', 'Empregos', 'fas fa-briefcase', 'oportunidades.html#empregos', ['emprego', 'vaga', 'vagas', 'clt']),
    ...
    createEntry('oportunidades', 'cursos-capacitacoes', 'Cursos e capacitações', 'fas fa-book-open-reader', 'oportunidades.html#cursos-capacitacoes', ['curso-capacitacao', 'cursos', 'capacitacao', 'capacitação', 'qualificacao', 'qualificação']),
    ...
    createEntry('achados-perdidos', 'perdidos', 'Itens perdidos', 'fas fa-search', 'achados-perdidos.html#perdidos', ['perdido', 'sumiu']),
    createEntry('achados-perdidos', 'encontrados', 'Itens encontrados', 'fas fa-hand-holding', 'achados-perdidos.html#encontrados', ['encontrado', 'achado']),
