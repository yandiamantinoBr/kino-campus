(function (root, factory) {
  ...
  const CATEGORY_CATALOG = Object.freeze([
    createEntry('compra-venda', 'eletronicos', 'Eletrônicos', 'fas fa-laptop', '/compra-venda#eletronicos', ['eletronico', 'celular', 'notebook', 'tablet', 'fone']),
    createEntry('compra-venda', 'livros', 'Livros e Materiais', 'fas fa-book', '/compra-venda#livros', ['livro', 'apostila', 'apostilas', 'materiais', 'material']),
    createEntry('compra-venda', 'ingressos', 'Ingressos', 'fas fa-ticket', '/compra-venda#ingressos', ['ingresso', 'ticket', 'evento']),
    createEntry('compra-venda', 'moveis', 'Móveis', 'fas fa-couch', '/compra-venda#moveis', ['movel', 'cadeira', 'mesa', 'armario', 'guarda-roupa']),
    createEntry('compra-venda', 'vestuario', 'Vestuário', 'fas fa-shirt', '/compra-venda#vestuario', ['roupa', 'roupas', 'camisa', 'casaco', 'calca', 'calça']),
    createEntry('compra-venda', 'outros', 'Outros itens', 'fas fa-box-open', '/compra-venda#outros', ['outro', 'diversos']),
    // Keys align with create-post schema + eventos.html (posts.category plural form).
    createEntry('eventos', 'academicos', 'Acadêmicos', 'fas fa-graduation-cap', '/eventos#academicos', ['academico', 'acadêmicos', 'semana academica', 'semana acadêmica']),
    createEntry('eventos', 'palestras', 'Palestras', 'fas fa-microphone-lines', '/eventos#palestras', ['palestra', 'mesa redonda', 'debate']),
    createEntry('eventos', 'congressos', 'Congressos', 'fas fa-users-rectangle', '/eventos#congressos', ['congresso', 'seminario', 'seminário', 'simposio', 'simpósio', 'jornada']),
    createEntry('eventos', 'cursos', 'Cursos', 'fas fa-book-open-reader', '/eventos#cursos', ['curso', 'minicurso', 'capacitacao', 'capacitação', 'formacao', 'formação']),
    createEntry('eventos', 'culturais', 'Culturais', 'fas fa-theater-masks', '/eventos#culturais', ['cultural', 'cultura', 'show', 'arte']),
    createEntry('eventos', 'esportivos', 'Esportivos', 'fas fa-running', '/eventos#esportivos', ['esportivo', 'esporte', 'corrida', 'torneio']),
    createEntry('eventos', 'workshops', 'Workshops', 'fas fa-chalkboard-teacher', '/eventos#workshops', ['workshop', 'oficina', 'tecnologia', 'hackathon', 'informatica', 'informática', 'computacao', 'computação']),
    createEntry('eventos', 'festas', 'Festas', 'fas fa-music', '/eventos#festas', ['festa', 'balada', 'show universitario', 'show universitário']),
    createEntry('eventos', 'sustentabilidade', 'Sustentabilidade', 'fas fa-leaf', '/eventos#sustentabilidade', ['sustentavel', 'sustentável', 'ambiental', 'eco', 'feira']),
    createEntry('moradia', 'republicas', 'Repúblicas', 'fas fa-users', '/moradia#republicas', ['republica', 'república', 'repúblicas']),
    createEntry('moradia', 'quartos', 'Quartos', 'fas fa-bed', '/moradia#quartos', ['quarto', 'dividir-quarto']),
    createEntry('moradia', 'apartamentos', 'Apartamentos', 'fas fa-building', '/moradia#apartamentos', ['apartamento', 'apto']),
    createEntry('moradia', 'casas', 'Casas', 'fas fa-house', '/moradia#casas', ['casa']),
    createEntry('moradia', 'procurando', 'Procurando moradia', 'fas fa-magnifying-glass-location', '/moradia#procurando', ['procuro', 'procurar']),
    createEntry('oportunidades', 'editais', 'Editais e chamadas', 'fas fa-file-signature', '/oportunidades#editais', ['edital', 'chamada publica', 'chamada pública', 'mobilidade', 'intercambio', 'intercâmbio', 'internacional']),
    createEntry('oportunidades', 'concursos', 'Concursos e seleções', 'fas fa-clipboard-check', '/oportunidades#concursos', ['concurso', 'selecao', 'seleção', 'processo seletivo']),
    createEntry('oportunidades', 'bolsas', 'Bolsas', 'fas fa-award', '/oportunidades#bolsas', ['bolsa', 'auxilio', 'auxílio', 'fomento']),
    createEntry('oportunidades', 'estagios', 'Estágios', 'fas fa-user-graduate', '/oportunidades#estagios', ['estagio', 'bolsa-estagio']),
    createEntry('oportunidades', 'empregos', 'Empregos', 'fas fa-briefcase', '/oportunidades#empregos', ['emprego', 'vaga', 'vagas', 'clt']),
    createEntry('oportunidades', 'freelancer', 'Freelancer', 'fas fa-laptop-code', '/oportunidades#freelancer', ['freela', 'freelas']),
    createEntry('oportunidades', 'monitoria', 'Monitoria e aulas', 'fas fa-chalkboard-teacher', '/oportunidades#monitoria', ['monitorias', 'aulas', 'aula', 'reforco', 'reforço']),
    createEntry('oportunidades', 'pesquisa', 'Pesquisa', 'fas fa-flask', '/oportunidades#pesquisa', ['pibic', 'pivic', 'iniciacao-cientifica', 'iniciação científica']),
    createEntry('oportunidades', 'cursos-capacitacoes', 'Cursos e capacitações', 'fas fa-book-open-reader', '/oportunidades#cursos-capacitacoes', ['curso-capacitacao', 'cursos', 'capacitacao', 'capacitação', 'qualificacao', 'qualificação']),
    createEntry('oportunidades', 'voluntariado', 'Voluntariado', 'fas fa-hands-helping', '/oportunidades#voluntariado', ['voluntariados', 'ong', 'extensao', 'extensão']),
    createEntry('caronas', 'ofereco', 'Ofereço carona', 'fas fa-car-side', '/caronas#ofereco', ['ofereço', 'ofereco carona']),
    createEntry('caronas', 'procuro', 'Procuro carona', 'fas fa-hand-paper', '/caronas#procuro', ['procuro carona']),
    createEntry('caronas', 'campus', 'Rotas para campus', 'fas fa-university', '/caronas#campus', ['samambaia', 'campus ii', 'colemar']),
    createEntry('caronas', 'centro', 'Rotas para o centro', 'fas fa-city', '/caronas#centro', ['setor central', 'centro']),
    createEntry('achados-perdidos', 'perdidos', 'Itens perdidos', 'fas fa-search', '/achados-perdidos#perdidos', ['perdido', 'sumiu']),
    createEntry('achados-perdidos', 'encontrados', 'Itens encontrados', 'fas fa-hand-holding', '/achados-perdidos#encontrados', ['encontrado', 'achado']),
    createEntry('achados-perdidos', 'documentos', 'Documentos', 'fas fa-id-card', '/achados-perdidos#documentos', ['rg', 'cpf', 'cartao', 'cartão']),
    createEntry('achados-perdidos', 'eletronicos', 'Eletrônicos', 'fas fa-mobile-alt', '/achados-perdidos#eletronicos', ['celular', 'fone', 'notebook']),
    createEntry('achados-perdidos', 'outros', 'Outros objetos', 'fas fa-box', '/achados-perdidos#outros', ['chave', 'garrafa', 'mochila'])
  ]);
