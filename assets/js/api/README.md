...
| `kc-api.authors.js` | `window._KCAPI.authors` | `MOCK_USERS`, indices e resolucao de autor legado |
| `kc-api.posts-normalize.js` | `window._KCAPI.postsNormalize` | Normalizacao de posts usada por `KCAPI.normalizePost` |
