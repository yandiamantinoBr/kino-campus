-- ============================================================
-- KinoCampus v9.2.2.0 — Paginação Cursor-Based do Feed
-- ============================================================
--
-- RPC:
--   - kc_get_feed_cursor → feed cursor-based com cursor opaco
--
-- Ordenações preservadas:
--   - votos      → highlight_score DESC, votos DESC, created_at DESC, id DESC
--   - comentados → last_comment_at DESC, created_at DESC, id DESC
--   - recentes   → bumped_at DESC NULLS LAST, created_at DESC, id DESC
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.kc_get_feed_cursor(TEXT, TEXT[], TEXT, TEXT, TEXT, TEXT, TEXT, INT, TEXT) TO anon;
GRANT EXECUTE ON FUNCTION public.kc_get_feed_cursor(TEXT, TEXT[], TEXT, TEXT, TEXT, TEXT, TEXT, INT, TEXT) TO authenticated;
