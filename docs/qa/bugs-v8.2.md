...
| QA-phase5-001 | ALTO | RESOLVIDO | Perfil publico de autor legado com `author_id` no formato `USER_xx` terminava em `Perfil nao encontrado` porque `getProfileById()` so consultava Supabase (onde esses IDs nao existem); corrigido com fallback para `MOCK_USERS` via `getAuthorById()` ja existente; validado em preview run4: 5/5 cenarios passaram | [report-phase5-legacy-profile-compat.md](/C:/Users/yan1n/Documents/GitHub/kino-campus/docs/qa/report-phase5-legacy-profile-compat.md) e [report-v8.2.6.2-preview-run4.md](/C:/Users/yan1n/Documents/GitHub/kino-campus/docs/qa/report-v8.2.6.2-preview-run4.md) | `codex/phase5-legacy-public-profile-compat` (PR #139) |
