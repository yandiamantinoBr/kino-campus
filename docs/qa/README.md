...
- `reports/`: reports ativos, template V26 de evidência autenticada real, template V37 de gate de entrada funcional, template V38 de rollback, template V39 de candidato funcional, template V40 auth callback, template V41 profile/avatar, template V42 admin/moderação, template V43 notification provider, template V44 search/FTS, template V45 CSS small change, template V46 public a11y, template V47 de seleção de readiness funcional, template V48 de redação de evidência externa, template V49 de freeze de escopo funcional, template V50 de intake funcional, template V51 de No-Go funcional, template V52 de rastreabilidade de gates, template V53 de manifesto de patch funcional, reports V56-V75 PUBLIC-A11Y e reports V76 da decomposição `KCAPI`.
...
39. Para a evidencia V66 de admin banners decorative icons, consulte `reports/report-v66-public-a11y-admin-banner-icons.md`.
40. Para a evidencia V67 de admin moderation residual decorative icons, consulte `reports/report-v67-public-a11y-admin-moderation-icons.md`.
41. Para a evidencia V68 de admin dashboard audit decorative icons, consulte `reports/report-v68-public-a11y-admin-dashboard-audit-icons.md`.
42. Para a evidencia V69 de pull-to-refresh decorative icons, consulte `reports/report-v69-public-a11y-pull-to-refresh-icons.md`.
43. Para a evidencia V70 de filters tab decorative icon, consulte `reports/report-v70-public-a11y-filters-tab-icon.md`.
44. Para a evidencia V71 de admin dashboard charts decorative icons, consulte `reports/report-v71-public-a11y-admin-dashboard-charts-icons.md`.
45. Para a evidencia V72 de admin dashboard controller decorative icons, consulte `reports/report-v72-public-a11y-admin-dashboard-controller-icons.md`.
46. Para a evidencia V73 de kc-comments decorative icons, consulte `reports/report-v73-public-a11y-kc-comments-icons.md`.
47. Para a evidencia V74 de admin-reports decorative icons, consulte `reports/report-v74-public-a11y-admin-reports-icons.md`.
48. Para a evidencia V75 de kc-ranking decorative icons, consulte `reports/report-v75-public-a11y-kc-ranking-icons.md`.
49. Registre evidencias em `reports/` usando `_TEMPLATE-authenticated-run.md` e o padrao `report-v26-auth-runN.md`.
49. Use `../archive/qa-legacy/_INDEX.md` apenas para rastreabilidade historica.
