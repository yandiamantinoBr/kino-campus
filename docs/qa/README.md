...
18. Para o candidato `CSS-SM-01`, use `reports/_TEMPLATE-css-small-change-evidence.md`.
19. Para o candidato `PUBLIC-A11Y-01`, use `reports/_TEMPLATE-public-a11y-evidence.md`.
20. Registre evidencias em `reports/` usando `_TEMPLATE-authenticated-run.md` e o padrao `report-v26-auth-runN.md`.
21. Use `../archive/qa-legacy/_INDEX.md` apenas para rastreabilidade historica.
