...
16. Quando houver mais de um pacote viavel, use `reports/_TEMPLATE-functional-candidate.md` para registrar a escolha.
17. Para o candidato `AUTH-CB-01`, use `reports/_TEMPLATE-auth-callback-evidence.md`.
18. Para o candidato `PROFILE-AV-01`, use `reports/_TEMPLATE-profile-avatar-evidence.md`.
19. Para o candidato `ADMIN-MOD-01`, use `reports/_TEMPLATE-admin-moderation-evidence.md`.
20. Para o candidato `NOTIF-SB-01`, use `reports/_TEMPLATE-notification-provider-evidence.md`.
21. Para o candidato `SEARCH-FTS-01`, use `reports/_TEMPLATE-search-fts-evidence.md`.
22. Para o candidato `CSS-SM-01`, use `reports/_TEMPLATE-css-small-change-evidence.md`.
23. Para o candidato `PUBLIC-A11Y-01`, use `reports/_TEMPLATE-public-a11y-evidence.md`.
24. Registre evidencias em `reports/` usando `_TEMPLATE-authenticated-run.md` e o padrao `report-v26-auth-runN.md`.
25. Use `../archive/qa-legacy/_INDEX.md` apenas para rastreabilidade historica.
