...
27. Registre evidencias em `reports/` usando `_TEMPLATE-authenticated-run.md` e o padrao `report-v26-auth-runN.md`.
28. Use `../archive/qa-legacy/_INDEX.md` apenas para rastreabilidade historica.
