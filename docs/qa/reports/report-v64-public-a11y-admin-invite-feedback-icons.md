# Report V64 - PUBLIC-A11Y-01 Admin Invite Feedback Icons

**Candidato:** `PUBLIC-A11Y-01`
**Versao:** `v64.0.0`
**Data:** `2026-04-30`
**Ambiente:** local
**Rota/componente:** admin invite feedback/loading
...
| Rota/componente unico definido | Sim - feedback de convites admin |
...
| Patches V54-V63 preservados | Sim |
...
|---|---|---|---|---|---|
| `assets/js/controllers/admin/admin-invite.controller.js` | funcional pontual | icones dinamicos de loading/copiar eram redundantes com texto visivel | baixo; atributo sem alteracao visual | `tests/a11y/a11y.test.js` | remover `aria-hidden="true"` adicionados |
...
|---|---|---|
| Template admin de convites inspecionado | Passou | icones `fa-spinner`, `fa-paper-plane`, `fa-check` e `fa-copy` declaram `aria-hidden="true"` |
...
| Gate | Estado |
|---|---|
| `npm test -- tests/a11y/a11y.test.js` | executado; 1/1 suite, 40/40 testes |
| `npm run check:all` | executado; 5/5 validators verdes, 135/135 suites, 3065/3065 testes |
| `npm test` | executado; 135/135 suites, 3065/3065 testes |
