...
**Versao:** v59.0.0
**Data:** 2026-04-30
**Atualizado em:** v59.0.0 - patch PUBLIC-A11Y mobile search modal input e janela raiz V55-V59
...
| Testes | Jest 135 suites / 3058 testes + Playwright 8 suites E2E |
| Gates locais | `npm run check:all` com 5 validadores |

V59 e uma versao funcional pequena. Este arquivo mantem o baseline estrutural reancorado em V23 e reflete a
...
patch PUBLIC-A11Y nos controles do modal de busca mobile V58 e patch PUBLIC-A11Y no input do modal
de busca mobile V59.
...
|---|---|
| `relatorios/` | Relatorios de encerramento V9, V11, V13-V54 |
...
A politica V22 limita a raiz a no maximo 5 relatorios recentes. Em V59, a janela operacional e:
...
| `npm test` | Mantem 135/135 suites e 3058/3058 testes Jest |
