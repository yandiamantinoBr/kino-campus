...
**Versao:** v63.0.0
**Data:** 2026-04-30
**Atualizado em:** v63.0.0 - patch PUBLIC-A11Y admin help load more icons e janela raiz V59-V63
...
| Testes | Jest 135 suites / 3064 testes + Playwright 8 suites E2E |
| Gates locais | `npm run check:all` com 5 validadores |

V63 e uma versao funcional pequena. Este arquivo mantem o baseline estrutural reancorado em V23 e reflete a
...
de botoes dinamicos publicos/admin V61 e patch PUBLIC-A11Y de icones decorativos admin V62 e patch PUBLIC-A11Y dos icones do carregar mais em pedidos admin V63.
...
A politica V22 limita a raiz a no maximo 5 relatorios recentes. Em V63, a janela operacional e:
...
| `npm test` | Mantem 135/135 suites e 3064/3064 testes Jest |
