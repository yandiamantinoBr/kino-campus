...
**Versao:** v46.0.0
**Data:** 2026-04-29
**Atualizado em:** v46.0.0 - dossie PUBLIC-A11Y-01 e janela raiz V42-V46
...
|-- RELATORIO-KINOCAMPUS-V43.md
|-- RELATORIO-KINOCAMPUS-V44.md
|-- RELATORIO-KINOCAMPUS-V45.md
`-- RELATORIO-KINOCAMPUS-V46.md
```
...
| `docs/planning/` | Inventarios V18, plano V19, ledger V24, readiness V26, readiness CSS V35, roadmap V36, gate funcional V37, rollback V38, matriz V39 e dossies V40-V46 |
| `docs/qa/` | Artefatos ativos de QA manual, RLS, XSS, reports V26, templates de gate funcional V37, rollback V38, candidato V39, auth callback V40, profile/avatar V41, admin/moderacao V42, notification provider V43, search/FTS V44, CSS small change V45 e public a11y V46, gate visual/a11y V27, matriz autenticada V31, politica E2E V32, politica LHCI V33 e plano a11y/i18n V34 |
...
|---|---|
| `relatorios/` | Relatorios de encerramento V9, V11, V13-V41 |
...
A politica V22 limita a raiz a no maximo 5 relatorios recentes. Em V46, a janela operacional e:
