...
**Versao:** v71.0.0
**Data:** 2026-05-05
**Atualizado em:** v71.0.0 - patch PUBLIC-A11Y admin dashboard charts decorative icons e janela raiz V67-V71
...
| Testes | Jest 135 suites / 3072 testes + Playwright 8 suites E2E |
| Gates locais | `npm run check:all` com 5 validadores |

V71 e uma versao funcional pequena. Este arquivo mantem o baseline estrutural reancorado em V23 e reflete a
...
patch PUBLIC-A11Y do icone decorativo da aba `Todas` dos filtros publicos V70 e patch PUBLIC-A11Y
dos 11 icones decorativos do ranking e modulos em admin-dashboard.charts.js V71.
...
A politica V22 limita a raiz a no maximo 5 relatorios recentes. Em V71, a janela operacional e:
...
| `npm test` | Mantem 135/135 suites e 3072/3072 testes Jest |
