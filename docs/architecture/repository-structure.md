...
**Versao:** v70.0.0
**Data:** 2026-05-06
**Atualizado em:** v70.0.0 - patch PUBLIC-A11Y filters tab decorative icon e janela raiz V66-V70
...
| Testes | Jest 135 suites / 3071 testes + Playwright 8 suites E2E |
| Gates locais | `npm run check:all` com 5 validadores |

V70 e uma versao funcional pequena. Este arquivo mantem o baseline estrutural reancorado em V23 e reflete a
...
de ajuda admin V65, patch PUBLIC-A11Y dos icones decorativos em banners admin V66 patch PUBLIC-A11Y dos icones residuais em moderacao admin V67 patch PUBLIC-A11Y dos icones de spinner do shard audit do dashboard admin V68 patch PUBLIC-A11Y dos icones decorativos do indicador de pull-to-refresh V69 e patch PUBLIC-A11Y do icone decorativo da aba `Todas` dos filtros publicos V70.
...
A politica V22 limita a raiz a no maximo 5 relatorios recentes. Em V70, a janela operacional e:
...
| `npm test` | Mantem 135/135 suites e 3071/3071 testes Jest |
