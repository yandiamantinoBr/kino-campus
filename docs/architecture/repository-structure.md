...
**Versao:** v57.0.0
**Data:** 2026-04-30
**Atualizado em:** v57.0.0 - patch PUBLIC-A11Y post card author avatar alt e janela raiz V53-V57
...
| Testes | Jest 134 suites / 3054 testes + Playwright 8 suites E2E |
| Gates locais | `npm run check:all` com 5 validadores |

V57 e uma versao funcional pequena. Este arquivo mantem o baseline estrutural reancorado em V23 e reflete a
...
patch PUBLIC-A11Y de icones decorativos V56 e patch PUBLIC-A11Y no alt do avatar de autor V57.
...
|---|---|
| `relatorios/` | Relatorios de encerramento V9, V11, V13-V52 |
...
A politica V22 limita a raiz a no maximo 5 relatorios recentes. Em V57, a janela operacional e:
...
| `npm test` | Mantem 134/134 suites e 3054/3054 testes Jest |
