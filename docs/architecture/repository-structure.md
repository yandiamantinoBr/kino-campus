...
**Versao:** v52.0.0
**Data:** 2026-04-30
**Atualizado em:** v52.0.0 - rastreabilidade de gates funcionais e janela raiz V48-V52
...
V52 e uma versao documental. Este arquivo mantem o baseline estrutural reancorado em V23 e reflete a
...
registro de No-Go funcional V51 e rastreabilidade de gates funcionais V52.
...
|---|---|
| `relatorios/` | Relatorios de encerramento V9, V11, V13-V47 |
...
A politica V22 limita a raiz a no maximo 5 relatorios recentes. Em V52, a janela operacional e:
