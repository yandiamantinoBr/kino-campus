...
**Versão:** v76.35.0
**Data:** 2026-06-19
**Atualizado em:** v76.35.0 - parser determinístico offline de consultas
...
| Testes | Jest 184 suites / 3732 testes + Playwright 10 specs E2E |
...
| `assets/js/shared/` | 9 | Dados e contratos compartilhados, incluindo registry e parser de busca ainda não carregados |
...
| `npm test` | Mantém 184/184 suites e 3732/3732 testes Jest |
