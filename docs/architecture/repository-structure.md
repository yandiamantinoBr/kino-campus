...
**Versao:** v58.0.0
**Data:** 2026-04-30
**Atualizado em:** v58.0.0 - patch PUBLIC-A11Y mobile search modal controls e janela raiz V54-V58
...
| Testes | Jest 135 suites / 3056 testes + Playwright 8 suites E2E |
| Gates locais | `npm run check:all` com 5 validadores |

V58 e uma versao funcional pequena. Este arquivo mantem o baseline estrutural reancorado em V23 e reflete a
...
patch PUBLIC-A11Y de icones decorativos V56, patch PUBLIC-A11Y no alt do avatar de autor V57 e
patch PUBLIC-A11Y nos controles do modal de busca mobile V58.
...
|---|---|
| `relatorios/` | Relatorios de encerramento V9, V11, V13-V53 |
...
A politica V22 limita a raiz a no maximo 5 relatorios recentes. Em V58, a janela operacional e:
...
| `npm test` | Mantem 135/135 suites e 3056/3056 testes Jest |
