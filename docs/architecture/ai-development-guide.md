...
**Versão:** v42.0.0 · **Atualizado em:** 2026-04-29
...
| Branch de features | `feature/v42.X.Y-descricao-curta` |
| appVersion | `42.0.0` (V42 encerrada; dossie ADMIN-MOD-01 documentado em `docs/planning/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V42.0-foundations
2. git pull
3. git checkout -b feature/v42.X.Y-descricao-curta
...
8. git push -u origin feature/v42.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V42.0-foundations
12. git pull
```
...
```
feature/v42.X.Y-descricao-curta

Exemplos válidos:
  feature/v42.1.0-admin-moderation-evidence
  feature/v42.2.0-admin-negative-control
  feature/v42.3.0-admin-go-no-go

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v42.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V42.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V42).
...
| Push direto para `kinocampus-V42.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V42, iterações, DoD | `RELATORIO-KINOCAMPUS-V42.md` |
