...
**Versão:** v48.0.0 · **Atualizado em:** 2026-04-29
...
| Branch de features | `feature/v48.X.Y-descricao-curta` |
| appVersion | `48.0.0` (V48 encerrada; pacote de evidencias externas sem secrets documentado em `docs/ops/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V48.0-foundations
2. git pull
3. git checkout -b feature/v48.X.Y-descricao-curta
...
8. git push -u origin feature/v48.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V48.0-foundations
12. git pull
```
...
```
feature/v48.X.Y-descricao-curta

Exemplos válidos:
  feature/v48.1.0-external-evidence-redaction
  feature/v48.2.0-external-evidence-rollback
  feature/v48.3.0-external-evidence-go-no-go

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v48.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V48.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V48).
...
| Push direto para `kinocampus-V48.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V48, iterações, DoD | `RELATORIO-KINOCAMPUS-V48.md` |
