...
**Versão:** v26.0.0 · **Atualizado em:** 2026-04-28
...
| Branch de features | `feature/v26.X.Y-descricao-curta` |
| appVersion | `26.0.0` (V26 encerrada; templates de evidencia QA real preparados em `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V26.0-foundations
2. git pull
3. git checkout -b feature/v26.X.Y-descricao-curta
...
8. git push -u origin feature/v26.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V26.0-foundations
12. git pull
```
...
```
feature/v26.X.Y-descricao-curta

Exemplos válidos:
  feature/v26.1.0-qa-evidence-template
  feature/v26.2.0-real-qa-execution
  feature/v26.3.0-qa-gate-status

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v26.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V26.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V26).
...
| Push direto para `kinocampus-V26.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V26, iterações, DoD | `RELATORIO-KINOCAMPUS-V26.md` |
