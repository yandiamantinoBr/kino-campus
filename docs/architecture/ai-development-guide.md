...
**Versão:** v33.0.0 · **Atualizado em:** 2026-04-28
...
| Branch de features | `feature/v33.X.Y-descricao-curta` |
| appVersion | `33.0.0` (V33 encerrada; politica LHCI documentada em `docs/qa/`) |
...
```
1. git checkout kinocampus-V33.0-foundations
2. git pull
3. git checkout -b feature/v33.X.Y-descricao-curta
...
8. git push -u origin feature/v33.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V33.0-foundations
12. git pull
```
...
```
feature/v33.X.Y-descricao-curta

Exemplos válidos:
  feature/v33.1.0-lhci-baseline-policy
  feature/v33.2.0-lhci-environment-classification
  feature/v33.3.0-lighthouse-evidence-template

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v33.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V33.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V33).
...
| Push direto para `kinocampus-V33.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V33, iterações, DoD | `RELATORIO-KINOCAMPUS-V33.md` |
