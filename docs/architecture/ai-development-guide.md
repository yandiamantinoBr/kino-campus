...
**Versão:** v30.0.0 · **Atualizado em:** 2026-04-28
...
| Campo | Valor |
|-------|-------|
| Branch principal | `kinocampus-V30.0-foundations` |
| Branch de features | `feature/v30.X.Y-descricao-curta` |
| appVersion | `30.0.0` (V30 encerrada; checklist de sandbox para providers de notificacao documentado em `docs/ops/`) |
...
```
1. git checkout kinocampus-V30.0-foundations
2. git pull
3. git checkout -b feature/v30.X.Y-descricao-curta
...
8. git push -u origin feature/v30.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V30.0-foundations
12. git pull
```
...
```
feature/v30.X.Y-descricao-curta

Exemplos válidos:
  feature/v30.1.0-email-provider-sandbox
  feature/v30.2.0-whatsapp-provider-sandbox
  feature/v30.3.0-dispatch-go-no-go-evidence

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v30.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V30.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V30).
...
| Push direto para `kinocampus-V30.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V30, iterações, DoD | `RELATORIO-KINOCAMPUS-V30.md` |
