...
**Versão:** v22.0.0 · **Atualizado em:** 2026-04-28
...
| Campo | Valor |
|-------|-------|
| Branch principal | `kinocampus-V22.0-foundations` |
| Branch de features | `feature/v22.X.Y-descricao-curta` |
| appVersion | `22.0.0` (V22 encerrada; raiz mantem V18+ e historico anterior em `docs/archive/relatorios/`) |
...
```
1. git checkout kinocampus-V22.0-foundations
2. git pull
3. git checkout -b feature/v22.X.Y-descricao-curta
...
8. git push -u origin feature/v22.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V22.0-foundations
12. git pull
```
...
```
feature/v22.X.Y-descricao-curta

Exemplos válidos:
  feature/v22.1.0-root-report-policy
  feature/v22.2.0-archive-root-reports
  feature/v22.3.0-history-links

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v22.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V22.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V22).
...
| Push direto para `kinocampus-V22.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V22, iterações, DoD | `RELATORIO-KINOCAMPUS-V22.md` |
