...
**Versão:** v29.0.0 · **Atualizado em:** 2026-04-28
...
| Branch de features | `feature/v29.X.Y-descricao-curta` |
| appVersion | `29.0.0` (V29 encerrada; checklist de evidencias Supabase Advisor documentado em `docs/ops/`) |
...
```
1. git checkout kinocampus-V29.0-foundations
2. git pull
3. git checkout -b feature/v29.X.Y-descricao-curta
...
8. git push -u origin feature/v29.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V29.0-foundations
12. git pull
```
...
```
feature/v29.X.Y-descricao-curta

Exemplos válidos:
  feature/v29.1.0-supabase-advisor-evidence
  feature/v29.2.0-avatar-storage-validation
  feature/v29.3.0-scheduler-runtime-evidence

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v29.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V29.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V29).
...
| Push direto para `kinocampus-V29.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V29, iterações, DoD | `RELATORIO-KINOCAMPUS-V29.md` |
