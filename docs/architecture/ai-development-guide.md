...
**Versão:** v37.0.0 · **Atualizado em:** 2026-04-29
...
| Branch de features | `feature/v37.X.Y-descricao-curta` |
| appVersion | `37.0.0` (V37 encerrada; gate de entrada funcional documentado em `docs/planning/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V37.0-foundations
2. git pull
3. git checkout -b feature/v37.X.Y-descricao-curta
...
8. git push -u origin feature/v37.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V37.0-foundations
12. git pull
```
...
```
feature/v37.X.Y-descricao-curta

Exemplos válidos:
  feature/v37.1.0-functional-entry-gate
  feature/v37.2.0-functional-gate-template
  feature/v37.3.0-go-no-go-evidence

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v37.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V37.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V37).
...
| Push direto para `kinocampus-V37.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V37, iterações, DoD | `RELATORIO-KINOCAMPUS-V37.md` |
