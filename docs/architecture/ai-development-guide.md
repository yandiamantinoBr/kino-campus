...
**Versão:** v45.0.0 · **Atualizado em:** 2026-04-29
...
| Branch de features | `feature/v45.X.Y-descricao-curta` |
| appVersion | `45.0.0` (V45 encerrada; dossie CSS-SM-01 documentado em `docs/planning/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V45.0-foundations
2. git pull
3. git checkout -b feature/v45.X.Y-descricao-curta
...
8. git push -u origin feature/v45.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V45.0-foundations
12. git pull
```
...
```
feature/v45.X.Y-descricao-curta

Exemplos válidos:
  feature/v45.1.0-css-baseline-evidence
  feature/v45.2.0-css-rollback-evidence
  feature/v45.3.0-css-go-no-go

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v45.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V45.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V45).
...
| Push direto para `kinocampus-V45.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V45, iterações, DoD | `RELATORIO-KINOCAMPUS-V45.md` |
