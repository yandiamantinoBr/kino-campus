...
**Versão:** v39.0.0 · **Atualizado em:** 2026-04-29
...
| Campo | Valor |
|-------|-------|
| Branch principal | `kinocampus-V39.0-foundations` |
| Branch de features | `feature/v39.X.Y-descricao-curta` |
| appVersion | `39.0.0` (V39 encerrada; matriz de candidatos funcionais documentada em `docs/planning/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V39.0-foundations
2. git pull
3. git checkout -b feature/v39.X.Y-descricao-curta
...
8. git push -u origin feature/v39.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V39.0-foundations
12. git pull
```
...
```
feature/v39.X.Y-descricao-curta

Exemplos válidos:
  feature/v39.1.0-functional-candidate-matrix
  feature/v39.2.0-first-package-selection
  feature/v39.3.0-candidate-evidence

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v39.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V39.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V39).
...
| Push direto para `kinocampus-V39.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V39, iterações, DoD | `RELATORIO-KINOCAMPUS-V39.md` |
