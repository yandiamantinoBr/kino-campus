...
**Versão:** v40.0.0 · **Atualizado em:** 2026-04-29
...
| Branch de features | `feature/v40.X.Y-descricao-curta` |
| appVersion | `40.0.0` (V40 encerrada; dossie AUTH-CB-01 documentado em `docs/planning/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V40.0-foundations
2. git pull
3. git checkout -b feature/v40.X.Y-descricao-curta
...
8. git push -u origin feature/v40.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V40.0-foundations
12. git pull
```
...
```
feature/v40.X.Y-descricao-curta

Exemplos válidos:
  feature/v40.1.0-auth-callback-evidence
  feature/v40.2.0-auth-callback-dossier
  feature/v40.3.0-auth-go-no-go

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v40.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V40.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V40).
...
| Push direto para `kinocampus-V40.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V40, iterações, DoD | `RELATORIO-KINOCAMPUS-V40.md` |
