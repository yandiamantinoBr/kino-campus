...
**Versão:** v60.0.0 · **Atualizado em:** 2026-04-30
...
| Campo | Valor |
|-------|-------|
| Branch principal | `kinocampus-V60.0-foundations` |
| Branch de features | `feature/v60.X.Y-descricao-curta` |
| appVersion | `60.0.0` (v60 encerrada; patch PUBLIC-A11Y pontual documentado em `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V60.0-foundations
2. git pull
3. git checkout -b feature/v60.X.Y-descricao-curta
4. [ implementar mudanças ]
5. npm run check:all          ← DEVE ser 5/5 verdes
   npm test                   ← DEVE ser ≥135/135 suites, ≥3060/3060 testes
6. git add <arquivos específicos>
7. git commit -m "tipo(escopo): descrição\n\nCo-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
8. git push -u origin feature/v60.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V60.0-foundations
12. git pull
```
...
```
feature/v60.X.Y-descricao-curta

Exemplos válidos:
  feature/v60.1.0-public-a11y-post-card-comments
  feature/v60.2.0-public-a11y-card-labels
  feature/v60.3.0-public-a11y-rendered-content

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v60.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V60.0-foundations"`
...
- Antes de commitar: `npm test` deve mostrar `≥135 passed, 135 total` e `≥3060 passed, 3060 total`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline v60).
...
| Push direto para `kinocampus-V60.0-foundations` | Branch protegida — fluxo via PR |
...
| Reduzir contagem de testes sem aprovação explícita | Contagem mínima é 135/3060 |
...
| Estado atual da release v60, iterações, DoD | `RELATORIO-KINOCAMPUS-V60.md` |
...
# Testes
npm test                 # 135 suites · 3060 testes
