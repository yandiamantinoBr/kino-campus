...
**Versão:** v38.0.0 · **Atualizado em:** 2026-04-29
...
| Branch de features | `feature/v38.X.Y-descricao-curta` |
| appVersion | `38.0.0` (V38 encerrada; gate de evidencia de rollback documentado em `docs/planning/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V38.0-foundations
2. git pull
3. git checkout -b feature/v38.X.Y-descricao-curta
...
8. git push -u origin feature/v38.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V38.0-foundations
12. git pull
```
...
```
feature/v38.X.Y-descricao-curta

Exemplos válidos:
  feature/v38.1.0-rollback-evidence-gate
  feature/v38.2.0-rollback-template
  feature/v38.3.0-revert-validation

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v38.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V38.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V38).
...
| Push direto para `kinocampus-V38.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V38, iterações, DoD | `RELATORIO-KINOCAMPUS-V38.md` |
