...
**Versão:** v46.0.0 · **Atualizado em:** 2026-04-29
...
| Branch de features | `feature/v46.X.Y-descricao-curta` |
| appVersion | `46.0.0` (V46 encerrada; dossie PUBLIC-A11Y-01 documentado em `docs/planning/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V46.0-foundations
2. git pull
3. git checkout -b feature/v46.X.Y-descricao-curta
...
8. git push -u origin feature/v46.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V46.0-foundations
12. git pull
```
...
```
feature/v46.X.Y-descricao-curta

Exemplos válidos:
  feature/v46.1.0-public-a11y-evidence
  feature/v46.2.0-a11y-rollback-evidence
  feature/v46.3.0-public-a11y-go-no-go

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v46.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V46.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V46).
...
| Push direto para `kinocampus-V46.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V46, iterações, DoD | `RELATORIO-KINOCAMPUS-V46.md` |
