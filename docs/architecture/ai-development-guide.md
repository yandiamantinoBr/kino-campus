...
**Versão:** v25.0.0 · **Atualizado em:** 2026-04-28
...
| Branch de features | `feature/v25.X.Y-descricao-curta` |
| appVersion | `25.0.0` (V25 encerrada; runbook de QA real criado em `docs/qa/`) |
...
```
1. git checkout kinocampus-V25.0-foundations
2. git pull
3. git checkout -b feature/v25.X.Y-descricao-curta
...
8. git push -u origin feature/v25.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V25.0-foundations
12. git pull
```
...
```
feature/v25.X.Y-descricao-curta

Exemplos válidos:
  feature/v25.1.0-real-qa-runbook
  feature/v25.2.0-operational-evidence
  feature/v25.3.0-qa-gate-status

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v25.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V25.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V25).
...
| Push direto para `kinocampus-V25.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V25, iterações, DoD | `RELATORIO-KINOCAMPUS-V25.md` |
