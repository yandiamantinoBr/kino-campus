...
**Versão:** v28.0.0 · **Atualizado em:** 2026-04-28
...
| Branch de features | `feature/v28.X.Y-descricao-curta` |
| appVersion | `28.0.0` (V28 encerrada; auditoria unaccent/FTS pre-migration documentada em `docs/ops/`) |
...
```
1. git checkout kinocampus-V28.0-foundations
2. git pull
3. git checkout -b feature/v28.X.Y-descricao-curta
...
8. git push -u origin feature/v28.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V28.0-foundations
12. git pull
```
...
```
feature/v28.X.Y-descricao-curta

Exemplos válidos:
  feature/v28.1.0-unaccent-audit
  feature/v28.2.0-isolated-sql-spike
  feature/v28.3.0-supabase-advisor-evidence

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v28.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V28.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V28).
...
| Push direto para `kinocampus-V28.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V28, iterações, DoD | `RELATORIO-KINOCAMPUS-V28.md` |
