...
**Versão:** v27.0.0 · **Atualizado em:** 2026-04-28
...
| Branch de features | `feature/v27.X.Y-descricao-curta` |
| appVersion | `27.0.0` (V27 encerrada; gate visual/a11y pre-CSS documentado em `docs/qa/`) |
...
```
1. git checkout kinocampus-V27.0-foundations
2. git pull
3. git checkout -b feature/v27.X.Y-descricao-curta
...
8. git push -u origin feature/v27.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V27.0-foundations
12. git pull
```
...
```
feature/v27.X.Y-descricao-curta

Exemplos válidos:
  feature/v27.1.0-visual-a11y-gate
  feature/v27.2.0-snapshot-baseline
  feature/v27.3.0-css-readiness

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v27.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V27.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V27).
...
| Push direto para `kinocampus-V27.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V27, iterações, DoD | `RELATORIO-KINOCAMPUS-V27.md` |
