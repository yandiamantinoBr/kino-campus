...
**Versão:** v49.0.0 · **Atualizado em:** 2026-04-29
...
| Campo | Valor |
|-------|-------|
| Branch principal | `kinocampus-V49.0-foundations` |
| Branch de features | `feature/v49.X.Y-descricao-curta` |
| appVersion | `49.0.0` (V49 encerrada; freeze de escopo funcional documentado em `docs/planning/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V49.0-foundations
2. git pull
3. git checkout -b feature/v49.X.Y-descricao-curta
...
8. git push -u origin feature/v49.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V49.0-foundations
12. git pull
```
...
```
feature/v49.X.Y-descricao-curta

Exemplos válidos:
  feature/v49.1.0-functional-scope-freeze
  feature/v49.2.0-functional-scope-rollback
  feature/v49.3.0-functional-scope-go-no-go

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v49.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V49.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V49).
...
| Push direto para `kinocampus-V49.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V49, iterações, DoD | `RELATORIO-KINOCAMPUS-V49.md` |
