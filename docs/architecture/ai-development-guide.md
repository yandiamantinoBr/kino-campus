...
**Versão:** v56.0.0 · **Atualizado em:** 2026-04-30
...
| Campo | Valor |
|-------|-------|
| Branch principal | `kinocampus-V56.0-foundations` |
| Branch de features | `feature/v56.X.Y-descricao-curta` |
| appVersion | `56.0.0` (v56 encerrada; patch PUBLIC-A11Y pontual documentado em `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V56.0-foundations
2. git pull
3. git checkout -b feature/v56.X.Y-descricao-curta
4. [ implementar mudanças ]
5. npm run check:all          ← DEVE ser 5/5 verdes
   npm test                   ← DEVE ser ≥134/134 suites, ≥3053/3053 testes
6. git add <arquivos específicos>
7. git commit -m "tipo(escopo): descrição\n\nCo-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
8. git push -u origin feature/v56.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V56.0-foundations
12. git pull
```
...
```
feature/v56.X.Y-descricao-curta

Exemplos válidos:
  feature/v56.1.0-public-a11y-post-card-comments
  feature/v56.2.0-public-a11y-card-labels
  feature/v56.3.0-public-a11y-rendered-content

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v56.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V56.0-foundations"`
...
- Antes de commitar: `npm test` deve mostrar `≥134 passed, 134 total` e `≥3053 passed, 3053 total`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline v56).
...
| Push direto para `kinocampus-V56.0-foundations` | Branch protegida — fluxo via PR |
...
| Reduzir contagem de testes sem aprovação explícita | Contagem mínima é 134/3053 |
...
| Estado atual da release v56, iterações, DoD | `RELATORIO-KINOCAMPUS-v56.md` |
...
# Testes
npm test                 # 134 suites · 3053 testes
