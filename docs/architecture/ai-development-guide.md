...
**Versão:** v41.0.0 · **Atualizado em:** 2026-04-29
...
| Branch de features | `feature/v41.X.Y-descricao-curta` |
| appVersion | `41.0.0` (V41 encerrada; dossie PROFILE-AV-01 documentado em `docs/planning/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V41.0-foundations
2. git pull
3. git checkout -b feature/v41.X.Y-descricao-curta
...
8. git push -u origin feature/v41.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V41.0-foundations
12. git pull
```
...
```
feature/v41.X.Y-descricao-curta

Exemplos válidos:
  feature/v41.1.0-profile-avatar-evidence
  feature/v41.2.0-storage-policy-dossier
  feature/v41.3.0-profile-go-no-go

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v41.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V41.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V41).
...
| Push direto para `kinocampus-V41.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V41, iterações, DoD | `RELATORIO-KINOCAMPUS-V41.md` |
