...
**Versão:** v31.0.0 · **Atualizado em:** 2026-04-28
...
| Campo | Valor |
|-------|-------|
| Branch principal | `kinocampus-V31.0-foundations` |
| Branch de features | `feature/v31.X.Y-descricao-curta` |
| appVersion | `31.0.0` (V31 encerrada; matriz de triagem autenticada documentada em `docs/qa/`) |
...
```
1. git checkout kinocampus-V31.0-foundations
2. git pull
3. git checkout -b feature/v31.X.Y-descricao-curta
...
8. git push -u origin feature/v31.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V31.0-foundations
12. git pull
```
...
```
feature/v31.X.Y-descricao-curta

Exemplos válidos:
  feature/v31.1.0-auth-callback-triage
  feature/v31.2.0-profile-avatar-triage
  feature/v31.3.0-admin-social-triage

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v31.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V31.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V31).
...
| Push direto para `kinocampus-V31.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V31, iterações, DoD | `RELATORIO-KINOCAMPUS-V31.md` |
