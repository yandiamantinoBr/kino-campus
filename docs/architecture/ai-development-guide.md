...
**Versão:** v34.0.0 · **Atualizado em:** 2026-04-28
...
| Branch de features | `feature/v34.X.Y-descricao-curta` |
| appVersion | `34.0.0` (V34 encerrada; reconciliacao a11y/i18n documentada em `docs/qa/`) |
...
```
1. git checkout kinocampus-V34.0-foundations
2. git pull
3. git checkout -b feature/v34.X.Y-descricao-curta
...
8. git push -u origin feature/v34.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V34.0-foundations
12. git pull
```
...
```
feature/v34.X.Y-descricao-curta

Exemplos válidos:
  feature/v34.1.0-a11y-i18n-reconciliation
  feature/v34.2.0-a11y-gap-report
  feature/v34.3.0-i18n-copy-audit

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v34.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V34.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V34).
...
| Push direto para `kinocampus-V34.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V34, iterações, DoD | `RELATORIO-KINOCAMPUS-V34.md` |
