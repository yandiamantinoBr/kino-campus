...
**Versão:** v47.0.0 · **Atualizado em:** 2026-04-29
...
| Branch de features | `feature/v47.X.Y-descricao-curta` |
| appVersion | `47.0.0` (V47 encerrada; consolidacao de readiness funcional documentada em `docs/planning/` e `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V47.0-foundations
2. git pull
3. git checkout -b feature/v47.X.Y-descricao-curta
...
8. git push -u origin feature/v47.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V47.0-foundations
12. git pull
```
...
```
feature/v47.X.Y-descricao-curta

Exemplos válidos:
  feature/v47.1.0-functional-readiness-selection
  feature/v47.2.0-functional-selection-rollback
  feature/v47.3.0-functional-selection-go-no-go

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v47.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V47.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V47).
...
| Push direto para `kinocampus-V47.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V47, iterações, DoD | `RELATORIO-KINOCAMPUS-V47.md` |
