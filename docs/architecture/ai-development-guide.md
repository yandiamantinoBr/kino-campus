...
**Versão:** v61.0.0 · **Atualizado em:** 2026-04-30
...
| Branch de features | `feature/v61.X.Y-descricao-curta` |
| appVersion | `61.0.0` (v61 encerrada; patch PUBLIC-A11Y pontual documentado em `docs/qa/reports/`) |
...
```
1. git checkout kinocampus-V61.0-foundations
2. git pull
3. git checkout -b feature/v61.X.Y-descricao-curta
4. [ implementar mudanças ]
5. npm run check:all          ← DEVE ser 5/5 verdes
   npm test                   ← DEVE ser ≥135/135 suites, ≥3062/3062 testes
6. git add <arquivos específicos>
7. git commit -m "tipo(escopo): descrição\n\nCo-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
8. git push -u origin feature/v61.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V61.0-foundations
12. git pull
```
...
```
feature/v61.X.Y-descricao-curta

Exemplos válidos:
  feature/v61.1.0-public-a11y-post-card-comments
  feature/v61.2.0-public-a11y-card-labels
  feature/v61.3.0-public-a11y-rendered-content

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v61.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V61.0-foundations"`
...
- Antes de commitar: `npm test` deve mostrar `≥135 passed, 135 total` e `≥3062 passed, 3062 total`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline v61).
...
| Push direto para `kinocampus-V61.0-foundations` | Branch protegida — fluxo via PR |
...
| Reduzir contagem de testes sem aprovação explícita | Contagem mínima é 135/3062 |
...
| Estado atual da release v61, iterações, DoD | `RELATORIO-KINOCAMPUS-v61.md` |
...
# Testes
npm test                 # 135 suites · 3062 testes
