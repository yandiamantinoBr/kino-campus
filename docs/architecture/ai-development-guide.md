...
**Versão:** v32.0.0 · **Atualizado em:** 2026-04-28
...
| Branch de features | `feature/v32.X.Y-descricao-curta` |
| appVersion | `32.0.0` (V32 encerrada; politica de gate E2E documentada em `docs/qa/`) |
...
```
1. git checkout kinocampus-V32.0-foundations
2. git pull
3. git checkout -b feature/v32.X.Y-descricao-curta
...
8. git push -u origin feature/v32.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V32.0-foundations
12. git pull
```
...
```
feature/v32.X.Y-descricao-curta

Exemplos válidos:
  feature/v32.1.0-e2e-gate-policy
  feature/v32.2.0-e2e-exception-template
  feature/v32.3.0-playwright-evidence-readiness

Proibido:
  main, master, develop, fix/..., hotfix/...
  Qualquer nome sem o prefixo feature/v32.X.Y-
```
...
- `branch` é exatamente `"kinocampus-V32.0-foundations"`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline V32).
...
| Push direto para `kinocampus-V32.0-foundations` | Branch protegida — fluxo via PR |
...
| Estado atual da release V32, iterações, DoD | `RELATORIO-KINOCAMPUS-V32.md` |
