...
| Testes | Jest (190 suites) + Playwright (11 specs E2E) | Nunca reduzir contagem |
...
- Antes de commitar: `npm test` deve mostrar `≥177 passed, 177 total` e `≥3600 passed, 3600 total`
