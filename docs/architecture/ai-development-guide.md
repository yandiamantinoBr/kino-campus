...
**Versão:** v71.0.0 · **Atualizado em:** 2026-05-05
...
| Campo | Valor |
|-------|-------|
| Branch principal | `kinocampus-V71.0-foundations` |
| Branch de features | `feature/v71.X.Y-descricao-curta` |
| appVersion | `71.0.0` (v71 encerrada; patch PUBLIC-A11Y pontual documentado em `docs/qa/reports/`) |
| frontendRuntimeVersion | `8.6.0` (constante canônica — **nunca alterar**) |
| Jest | 135 suites · 3072 testes |
...
```
1. git checkout kinocampus-V71.0-foundations
2. git pull
3. git checkout -b feature/v71.X.Y-descricao-curta
4. [ implementar mudanças ]
5. npm run check:all          ← DEVE ser 5/5 verdes
   npm test                   ← DEVE ser ≥135/135 suites, ≥3072/3072 testes
6. git add <arquivos específicos>
7. git commit -m "tipo(escopo): descrição\n\nCo-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
8. git push -u origin feature/v71.X.Y-descricao-curta
9. gh pr create --title "..." --body "..."
10. gh pr merge <número> --squash --delete-branch
11. git checkout kinocampus-V71.0-foundations
12. git pull
```
...
```
feature/v71.X.Y-descricao-curta
...
- `branch` é exatamente `"kinocampus-V71.0-foundations"`
...
- Antes de commitar: `npm test` deve mostrar `≥135 passed, 135 total` e `≥3072 passed, 3072 total`
...
arquivos canônicos. Validator agora verifica 156 itens (baseline v71).
...
| Push direto para `kinocampus-V71.0-foundations` | Branch protegida — fluxo via PR |
...
| Reduzir contagem de testes sem aprovação explícita | Contagem mínima é 135/3072 |
...
# Testes
npm test                 # 135 suites · 3072 testes
