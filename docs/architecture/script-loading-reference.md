...
**Versao:** v76.1.0
**Data:** 2026-06-12
**Criado em:** v16.6.0; regenerado em v76.1.0
...
59. `assets/js/controllers/public/create-post.controller.js?v=8.6.1` (controllers)
...
84. `assets/js/features/kc-ranking.js?v=8.6.1` (features)
85. `assets/js/controllers/public/kc-feed.controller.js?v=8.6.1` (controllers)
86. `assets/js/features/kc-feed-tabs-personalized.js?v=8.6.1` (features)
87. `assets/js/controllers/public/index.controller.js?v=8.6.1` (controllers)
88. `assets/js/features/kc-events-calendar.js?v=8.6.4` (features)
89. `assets/js/features/kc-banners.js?v=8.6.1` (features)
90. `assets/js/features/kc-search-modal.js?v=8.6.1` (features)

### `_product.html` (94 scripts)
...
56. `assets/js/shared/account-profile.shared.js?v=8.6.1` (shared)
...
72. `assets/js/features/kc-lazy-loader.js?v=8.6.1` (features)
73. `assets/js/core/kc-auth.ui.js?v=8.6.1` (core)
74. `assets/js/core/kc-notifications.js?v=8.6.1` (core)
75. `assets/js/controllers/public/product.controller.js?v=8.6.1` (controllers)
76. `assets/js/controllers/public/product.render.js?v=8.6.1` (controllers)
77. `assets/js/controllers/public/product.load.js?v=8.6.1` (controllers)
78. `assets/js/controllers/public/product.report.js?v=8.6.1` (controllers)
79. `assets/js/controllers/public/product.related.js?v=8.6.1` (controllers)
80. `assets/js/controllers/public/product.calendar.js?v=8.6.1` (controllers)
81. `assets/js/controllers/public/product.save.js?v=8.6.1` (controllers)
82. `assets/js/controllers/public/product.ratings.js?v=8.6.1` (controllers)
83. `assets/js/controllers/public/product.edit.js?v=8.6.1` (controllers)
84. `assets/js/controllers/public/product.analytics.js?v=8.6.1` (controllers)
85. `assets/js/controllers/public/product.popovers.js?v=8.6.1` (controllers)
86. `assets/js/controllers/public/product.lightbox.js?v=8.6.1` (controllers)
87. `assets/js/core/kc-theme.js?v=8.6.1` (core)
88. `assets/js/shared/search-analytics.shared.js?v=8.6.1` (shared)
89. `assets/js/shared/home-categories.shared.js?v=8.6.1` (shared)
90. `assets/js/features/kc-home-categories.js?v=8.6.1` (features)
91. `assets/js/features/kc-nav-links-personalized.js?v=8.6.3` (features)
92. `assets/js/shared/kc-search.shared.js?v=8.6.2` (shared)
93. `assets/js/features/kc-search.js?v=8.6.3` (features)
94. `assets/js/features/kc-search-modal.js?v=8.6.1` (features)

### `account-setup.html` (62 scripts)
...
56. `assets/js/shared/account-profile.shared.js?v=8.6.1` (shared)
57. `assets/js/core/kc-profiles.client.js?v=8.6.1` (core)
58. `assets/js/core/kc-public-shell.js?v=8.6.1` (core)
...
62. `assets/js/controllers/public/account-setup.controller.js?v=8.6.1` (controllers)

### `achados-perdidos.html` (89 scripts)
...
73. `assets/js/core/kc-auth.ui.js?v=8.6.1` (core)
74. `assets/js/core/kc-notifications.js?v=8.6.1` (core)
75. `assets/js/features/kc-pull-to-refresh.js?v=8.6.1` (features)
76. `assets/js/controllers/public/kc-feed.controller.js?v=8.6.1` (controllers)
77. `assets/js/controllers/public/achados-perdidos.controller.js?v=8.6.1` (controllers)
...
72. `assets/js/controllers/public/help.controller.js?v=8.6.1` (controllers)

### `auth-callback.html` (62 scripts)
...
60. `assets/js/core/kc-notifications.js?v=8.6.1` (core)
61. `assets/js/core/kc-theme.js?v=8.6.1` (core)
62. `assets/js/core/kc-auth-callback.js?v=8.6.1` (core)

### `caronas-feed.html` (89 scripts)
...
75. `assets/js/features/kc-pull-to-refresh.js?v=8.6.1` (features)
76. `assets/js/controllers/public/kc-feed.controller.js?v=8.6.1` (controllers)
77. `assets/js/controllers/public/caronas-feed.controller.js?v=8.6.1` (controllers)
78. `assets/js/core/kc-theme.js?v=8.6.1` (core)
79. `assets/js/features/kc-filters.js?v=8.6.2` (features)
80. `assets/js/features/kc-feed-filters.js?v=8.6.1` (features)
81. `assets/js/shared/search-analytics.shared.js?v=8.6.1` (shared)
...
### `compra-venda-feed.html` (89 scripts)
...
75. `assets/js/features/kc-pull-to-refresh.js?v=8.6.1` (features)
76. `assets/js/controllers/public/kc-feed.controller.js?v=8.6.1` (controllers)
77. `assets/js/controllers/public/compra-venda-feed.controller.js?v=8.6.1` (controllers)
78. `assets/js/core/kc-theme.js?v=8.6.1` (core)
79. `assets/js/features/kc-filters.js?v=8.6.2` (features)
80. `assets/js/features/kc-feed-filters.js?v=8.6.1` (features)
81. `assets/js/shared/search-analytics.shared.js?v=8.6.1` (shared)
...
76. `assets/js/shared/kc-search.shared.js?v=8.6.2` (shared)
77. `assets/js/features/kc-search.js?v=8.6.3` (features)
78. `assets/js/features/kc-search-modal.js?v=8.6.1` (features)

### `eventos.html` (90 scripts)
...
76. `assets/js/features/kc-filters.js?v=8.6.2` (features)
77. `assets/js/features/kc-feed-filters.js?v=8.6.1` (features)
...
85. `assets/js/controllers/public/kc-feed.controller.js?v=8.6.1` (controllers)
86. `assets/js/features/kc-events-calendar.js?v=8.6.4` (features)
87. `assets/js/controllers/public/eventos.controller.js?v=8.6.1` (controllers)
...
84. `assets/js/features/kc-pull-to-refresh.js?v=8.6.1` (features)
85. `assets/js/controllers/public/kc-feed.controller.js?v=8.6.1` (controllers)
86. `assets/js/controllers/public/moradia.controller.js?v=8.6.1` (controllers)
87. `assets/js/features/kc-search-modal.js?v=8.6.1` (features)
88. `assets/js/features/kc-lazy-loader.js?v=8.6.1` (features)
89. `assets/js/features/kc-ranking.js?v=8.6.1` (features)

### `my-posts.html` (82 scripts)
...
72. `assets/js/core/kc-auth.ui.js?v=8.6.1` (core)
73. `assets/js/core/kc-notifications.js?v=8.6.1` (core)
74. `assets/js/controllers/public/my-posts.controller.js?v=8.6.1` (controllers)
75. `assets/js/core/kc-theme.js?v=8.6.1` (core)
...
82. `assets/js/shared/ods.shared.js?v=8.6.1` (shared)
83. `assets/js/controllers/public/ods.controller.js?v=8.6.1` (controllers)

### `oportunidades.html` (90 scripts)
...
84. `assets/js/features/kc-pull-to-refresh.js?v=8.6.1` (features)
85. `assets/js/controllers/public/kc-feed.controller.js?v=8.6.1` (controllers)
86. `assets/js/controllers/public/oportunidades.normalize.js?v=8.6.1` (controllers)
87. `assets/js/controllers/public/oportunidades.controller.js?v=8.6.1` (controllers)
88. `assets/js/features/kc-search-modal.js?v=8.6.1` (features)
89. `assets/js/features/kc-lazy-loader.js?v=8.6.1` (features)
90. `assets/js/features/kc-ranking.js?v=8.6.1` (features)

### `profile.html` (76 scripts)
...
55. `assets/js/adapters/supabase/supabase.adapter.js?v=8.6.1` (adapters)
56. `assets/js/shared/account-profile.shared.js?v=8.6.1` (shared)
57. `assets/js/features/kc-comments.js?v=8.6.1` (features)
58. `assets/js/core/kc-profiles.client.js?v=8.6.1` (core)
...
71. `assets/js/features/kc-ranking.js?v=8.6.1` (features)
72. `assets/js/controllers/public/profile.presentation.js?v=8.6.1` (controllers)
73. `assets/js/controllers/public/profile.collections.js?v=8.6.2` (controllers)
74. `assets/js/controllers/public/profile.ratings.js?v=8.6.1` (controllers)
75. `assets/js/controllers/public/profile.flow.js?v=8.6.1` (controllers)
76. `assets/js/controllers/public/profile.controller.js?v=8.6.1` (controllers)

### `privacidade.html` (65 scripts)
...
### `search-results.html` (81 scripts)
...
70. `assets/js/controllers/public/settings.controller.js?v=8.6.1` (controllers)

### `transparencia.html` (65 scripts)
...
56. `assets/js/features/kc-pull-to-refresh.js?v=8.6.1` (features)
...
62. `assets/js/controllers/admin/admin-dashboard.shared.js?v=8.6.6` (controllers)
63. `assets/js/controllers/admin/admin-dashboard.metrics.js?v=8.6.6` (controllers)
64. `assets/js/controllers/admin/admin-dashboard.audit.js?v=8.6.7` (controllers)
65. `assets/js/controllers/admin/admin-dashboard.charts.js?v=8.6.6` (controllers)
66. `assets/js/features/kc-ranking.js?v=8.6.1` (features)
67. `assets/js/controllers/admin/admin-dashboard.privacy.js?v=8.6.2` (controllers)
68. `assets/js/controllers/admin/admin-dashboard.controller.js?v=8.6.6` (controllers)

### `admin/moderation.html` (63 scripts)
...
61. `assets/js/controllers/admin/admin-moderation.controller.js?v=8.6.4` (controllers)
62. `assets/js/controllers/admin/admin-invite.controller.js?v=8.6.1` (controllers)
63. `assets/js/controllers/admin/admin-external-access.controller.js?v=8.6.2` (controllers)

### `admin/reports.html` (61 scripts)
...
59. `assets/js/api/admin-shell.js?v=8.6.1` (api)
60. `assets/js/controllers/admin/admin-export.shared.js?v=8.6.9` (controllers)
61. `assets/js/controllers/admin/admin-reports.controller.js?v=8.6.5` (controllers)

### `admin/banners.html` (63 scripts)
...
58. `assets/js/core/kc-theme.js?v=8.6.1` (core)
59. `assets/js/api/admin-shell.js?v=8.6.1` (api)
60. `assets/js/features/kc-ads.js?v=8.6.5` (features)
61. `assets/js/controllers/admin/admin-export.shared.js?v=8.6.9` (controllers)
62. `assets/js/controllers/admin/admin-banners.controller.js?v=8.6.5` (controllers)
63. `assets/js/controllers/admin/admin-feed-ads.controller.js?v=8.6.5` (controllers)

### `admin/help-requests.html` (62 scripts)
...
41. `assets/js/adapters/local/local.posts-write.adapter.js?v=8.6.1` (adapters)
42. `assets/js/adapters/local/local.profile.adapter.js?v=8.6.1` (adapters)
43. `assets/js/adapters/local/local.help.adapter.js?v=8.6.2` (adapters)
44. `assets/js/adapters/supabase/supabase.analytics.adapter.js?v=8.6.1` (adapters)
45. `assets/js/adapters/supabase/supabase.admin.adapter.js?v=8.6.5` (adapters)
46. `assets/js/adapters/supabase/supabase.comments.adapter.js?v=8.6.1` (adapters)
47. `assets/js/adapters/supabase/supabase.votes.adapter.js?v=8.6.1` (adapters)
48. `assets/js/adapters/supabase/supabase.media.adapter.js?v=8.6.1` (adapters)
49. `assets/js/adapters/supabase/supabase.posts-read.adapter.js?v=8.6.1` (adapters)
...
53. `assets/js/adapters/supabase/supabase.profiles.adapter.js?v=8.6.1` (adapters)
54. `assets/js/adapters/supabase/supabase.adapter.js?v=8.6.1` (adapters)
55. `assets/js/shared/help.shared.js?v=8.6.3` (shared)
...
60. `assets/js/api/admin-shell.js?v=8.6.1` (api)
61. `assets/js/controllers/admin/admin-export.shared.js?v=8.6.9` (controllers)
62. `assets/js/controllers/admin/admin-help-requests.controller.js?v=8.6.9` (controllers)

### `admin/privacy-analytics.html` (61 scripts)
...
59. `assets/js/api/admin-shell.js?v=8.6.1` (api)
60. `assets/js/controllers/admin/admin-export.shared.js?v=8.6.9` (controllers)
61. `assets/js/controllers/admin/admin-privacy-analytics.controller.js?v=8.6.3` (controllers)
