...
1) **Separação Frontend/Backend (histórico)**
- `frontend/` contém todas as páginas e assets.
- O antigo placeholder de backend foi movido para `docs/legacy/backend-placeholder/` apenas para referência histórica.
