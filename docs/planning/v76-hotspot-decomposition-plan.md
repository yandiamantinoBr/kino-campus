...
**Versão:** v76.15.0
**Data:** 2026-06-15
**Escopo:** planejamento técnico + status das extrações JS V76, inventário residual JS-I, extrações JS-I.1/JS-I.2/JS-I.3, inventário CSS-A, baseline CSS-B e micro-splits CSS-C/C.2; sem alterar SQL, secrets, provider ou deploy
...
| `assets/css/styles.css` | 12.089 linhas / 281.919 bytes | regressão visual transversal em páginas públicas/admin e quebra de cascade |
...
Próxima entrega recomendada: escolher uma frente única, sem misturar no mesmo PR: CSS-C.3 em
`Chat overlap` se o atalho global for preservado, CSS-B autenticado para dashboard admin real ou
