...
| `v76-search-personalization-architecture-plan.md` | Plano V76.32–V76.39; piloto estruturado concluído sob duas flags desligadas; chips, facetas e zero-results como próximo gate |
