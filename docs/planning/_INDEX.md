...
| `v76-search-personalization-architecture-plan.md` | Plano V76.32–V76.40; critérios removíveis e facetas concluídos sob duas flags desligadas; dossiê SQL/RPC isolado como próximo gate |
