...
| `v76-search-personalization-architecture-plan.md` | Plano V76.32–V76.43; UX, dossiê SQL/RPC, combobox/cancelamento e preferências explícitas/consentimento concluídos; afinidade local opt-in como próximo gate |
