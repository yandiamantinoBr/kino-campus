...
| `v76-search-personalization-architecture-plan.md` | Plano V76.32–V76.35; registro, projeção local e parser offline concluídos, integração shadow como próximo gate |
