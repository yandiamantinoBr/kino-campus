...
| `v76-search-personalization-architecture-plan.md` | Plano V76.32–V76.41; UX estruturada e dossiê SQL/RPC concluídos sem migration; combobox/cancelamento/performance real como próximo gate |
