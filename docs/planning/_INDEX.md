...
| `v76-search-personalization-architecture-plan.md` | Plano V76.32–V76.36; registro, projeção, parser e integração shadow offline concluídos; cobertura temporal e benchmark como próximo gate |
