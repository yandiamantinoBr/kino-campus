...
| `v76-search-personalization-architecture-plan.md` | Plano V76.32–V76.37; shadow temporal/status e benchmark concluídos; snapshot gerado e lazy loading como próximo gate |
