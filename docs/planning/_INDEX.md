...
| `v76-search-personalization-architecture-plan.md` | Plano V76.32–V76.50; UX, SQL/RPC documental, combobox/cancelamento, preferências explícitas e afinidade local opt-in concluídos; cadeia canônica de migrations reparada como baseline consolidada (V76.47) e revalidação do gate SQL por evidência como próximo passo |
