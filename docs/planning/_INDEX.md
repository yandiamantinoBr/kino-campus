...
| `v76-search-personalization-architecture-plan.md` | Plano V76.32–V76.38; snapshot e lazy runtime concluídos sob flag desligada; piloto controlado como próximo gate |
