...
| ID | Prioridade | Item | Evidencia | Acao V19 |
|---|---|---|---|---|
...
| DOC-004 | P1 | `docs/qa/` mistura material operacional ativo com historico V8/V11 | `docs/qa/README.md`, `docs/qa/reports/*` | Classificar artefatos: ativo, historico a arquivar, template, evidencia antiga |
...
| QA-005 | P1 | `docs/qa/reports/repository-reorg-smoke.md` tem checkboxes historicos nao fechados | Relatorio de smoke V15 | Arquivar como historico ou atualizar status de encerramento documental |
...
| REP-003 | P2 | Busca textual e grep sao poluidos por docs historicos ativos | `docs/qa/` e `.claude/worktrees` | Reduzir falsos positivos com reorganizacao documental V19 |
