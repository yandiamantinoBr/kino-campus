...
> **Estado documental:** v41.0.0 (2026-04-29). As anotações de versão ao longo deste documento (`v9.x.x`, `v9.1.x`, `v11.x.x`, etc.) são marcadores históricos que indicam quando cada tabela, coluna ou trigger foi introduzido — não indicam a versão atual do repositório. O estado ativo do banco reflete as 83 migrations versionadas em `supabase/migrations/`.
