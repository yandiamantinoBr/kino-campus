...
| Drift de testes 135/3076 vs contagem real atual | Resolvido em #550; estado atual pos-V76 confirmado em 169/3524 |
...
| Jest | 169 suites / 3524 testes passed | `npm test` |
...
| # | Achado V1/V2 | Status atual | Evidencia | Severidade residual |
|---|---|---|---|---|
| A1 | `kc-api.client.js` 119KB / 2.809 linhas | **Parcialmente reduzido em runtime**; diagnostics de create-post extraido para `kc-api.diagnostics.js`, contrato publico preservado em 107 membros | `docs/planning/v76-hotspot-decomposition-plan.md`; `docs/qa/reports/report-v76-kcapi-diagnostics-extraction-2026-06-12.md` | Alto (evolucao) |
...
| A5 | Drift de testes 135 vs 169 | **Resolvido** | README:23, ai-development-guide:52, architecture.md:22 dizem 169/3524 apos o snapshot V76; Playwright 9/59 | Nenhum |
...
| Item | Razao | Acao |
|---|---|---|
| `kc-api.client.js` 119KB / 2.809 linhas | Ja tem sub-modulos `_KCAPI.*` extraidos; diagnostics de create-post saiu da fachada; fachada principal segue grande | Usar `docs/planning/v76-hotspot-decomposition-plan.md`; proximo passo recomendado: contrato/isolamento de `KCSessionStore` e `KCPostFreshness` antes de qualquer `normalizePost` |
