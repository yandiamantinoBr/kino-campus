...
| Drift de testes 135/3076 vs contagem real atual | Resolvido em #550; estado atual pos-V76 confirmado em 170/3535 |
...
| Jest | 170 suites / 3535 testes passed | `npm test` |
...
| # | Achado V1/V2 | Status atual | Evidencia | Severidade residual |
|---|---|---|---|---|
| A1 | `kc-api.client.js` 105KB / 2.433 linhas | **Parcialmente reduzido em runtime**; diagnostics e session/freshness extraidos para submodulos, contrato publico preservado em 107 membros | `docs/planning/v76-hotspot-decomposition-plan.md`; reports V76 de public surface, diagnostics e session | Alto (evolucao) |
...
| A5 | Drift de testes 135 vs 170 | **Resolvido** | README:23, ai-development-guide:52, architecture.md:22 dizem 170/3535 apos o snapshot V76; Playwright 9/59 | Nenhum |
...
| Item | Razao | Acao |
|---|---|---|
| `kc-api.client.js` 105KB / 2.433 linhas | Ja tem sub-modulos `_KCAPI.*` extraidos; diagnostics e session/freshness sairam da fachada; fachada principal segue grande | Usar `docs/planning/v76-hotspot-decomposition-plan.md`; proximo passo recomendado: recorte menor de filtros/date presets ou mocks de autor antes de qualquer `normalizePost` |
