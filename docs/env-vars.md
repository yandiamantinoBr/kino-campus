...
- A baseline documental atual do repositorio esta em `v32.0.0`.
...
- Essa diferenca nao e drift pendente: e a separacao formal entre versao documental/app (`32.0.0`) e runtime frontend (`8.6.0`).
