...
- A baseline atual do repositorio esta em `v61.0.0`.
...
- Essa diferenca nao e drift pendente: e a separacao formal entre versao app (`61.0.0`) e runtime frontend (`8.6.0`).
...
Hoje, o checker continua orientado pela versão canônica `8.6.0`, o que é coerente com os arquivos versionados de frontend. A versão app atual é `61.0.0` e fica registrada em `VERSION.json`.
