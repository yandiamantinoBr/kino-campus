...
- linha de trabalho atual: `v76.35` (parser determinístico offline de busca, runtime frontend `8.6.1` inalterado)
...
| [architecture/test-strategy.md](./architecture/test-strategy.md) | estratégia de 184 suites: onde adicionar testes, regras de manutenção *(contagem v76.35)* |
...
- Estado operacional atual: `appVersion=75.1.0`, `frontendRuntimeVersion=8.6.1`, 184 suites Jest / 3732 testes e 10 specs Playwright / 68 testes listados.
