...
| [qa/reports/report-v76-cadu-deadline-normalization-2026-07-02.md](./qa/reports/report-v76-cadu-deadline-normalization-2026-07-02.md) | evidência V76 da normalização de `deadline_date` para oportunidades no publisher Cadu e na Edge Function `cadu-publish`, corrigindo prazo principal vs datas de cronograma |
