...
- linha de trabalho atual: `v76.2` (decomposicao JS controlada, runtime `8.6.1`)
...
| [architecture/repository-structure.md](./architecture/repository-structure.md) | estrutura atual do repositorio pos-V22, reancorada em v76.2 |
...
| [architecture/script-loading-reference.md](./architecture/script-loading-reference.md) | ordem de carregamento de scripts em 26 HTMLs *(v16.6.0; contagem v76.2)* |
...
| [architecture/test-strategy.md](./architecture/test-strategy.md) | estrategia de 170 suites: onde adicionar testes, regras de manutencao *(v16.9.0; contagem v76.2)* |
...
- Estado operacional atual: `appVersion=75.1.0`, `frontendRuntimeVersion=8.6.1`, 170 suites Jest / 3535 testes e 9 specs Playwright / 59 testes listados.
