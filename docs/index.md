...
| [architecture/test-strategy.md](./architecture/test-strategy.md) | estratégia de 189 suites: onde adicionar testes, regras de manutenção *(contagem v76.40)* |
...
- Estado operacional atual: `appVersion=75.1.0`, `frontendRuntimeVersion=8.6.1`, 189 suites Jest / 3772 testes e 11 specs Playwright / 74 testes listados.
