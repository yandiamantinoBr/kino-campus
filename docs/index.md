...
- linha de trabalho atual: `v76.36` (pipeline shadow offline da busca estruturada, runtime frontend `8.6.1` inalterado)
...
| [architecture/test-strategy.md](./architecture/test-strategy.md) | estratégia de 185 suites: onde adicionar testes, regras de manutenção *(contagem v76.36)* |
...
- Estado operacional atual: `appVersion=75.1.0`, `frontendRuntimeVersion=8.6.1`, 185 suites Jest / 3742 testes e 10 specs Playwright / 68 testes listados.
