...
- linha de trabalho atual: `v76.34` (projeção estruturada local sob flag off, runtime frontend `8.6.1` inalterado)
...
| [architecture/test-strategy.md](./architecture/test-strategy.md) | estratégia de 183 suites: onde adicionar testes, regras de manutenção *(contagem v76.33)* |
...
- Estado operacional atual: `appVersion=75.1.0`, `frontendRuntimeVersion=8.6.1`, 183 suites Jest / 3691 testes e 10 specs Playwright / 68 testes listados.
