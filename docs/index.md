...
- linha de trabalho atual: `v76.10` (inventario residual JS-I da fachada `KCAPI`, runtime `8.6.1`)
...
| [architecture/repository-structure.md](./architecture/repository-structure.md) | estrutura atual do repositorio pos-V22, reancorada em v76.10 |
