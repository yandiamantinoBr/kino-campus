...
- linha de trabalho atual: `v76.11` (extracao JS-I.1 external access da fachada `KCAPI`, runtime `8.6.1`)
...
| [architecture/repository-structure.md](./architecture/repository-structure.md) | estrutura atual do repositorio pos-V22, reancorada em v76.11 |
...
| [architecture/test-strategy.md](./architecture/test-strategy.md) | estrategia de 175 suites: onde adicionar testes, regras de manutencao *(v16.9.0; contagem v76.11)* |
