...
- referência histórica da linha `v76.53`: busca orientada ao schema e personalização responsável, cadeia de migrations e chat com checkmarks/reactions/reply; seus números e medições SQL são snapshots daquela etapa, não inventário atual. Runtime frontend canônico: `8.6.1`.
...
- branch-base operacional: `main`; `kinocampus-V75.0-foundations` foi consolidada e aposentada. [Auditoria de branches e decisões preservadas](./ops/branch-consolidation-2026-08-31.md).
...
| [architecture/test-strategy.md](./architecture/test-strategy.md) | onde adicionar testes e regras de manutenção; contagens internas são históricas |
...
| [qa/reports/report-v76-cadu-deadline-normalization-2026-07-02.md](./qa/reports/report-v76-cadu-deadline-normalization-2026-07-02.md) | evidência V76 da normalização de `deadline_date` para oportunidades no publisher Cadu/Edge Function e do diagnóstico read-only no admin para prazos ausentes/eventos sem data |
...
| [qa/reports/report-v76-search-structured-pilot-2026-06-20.md](./qa/reports/report-v76-search-structured-pilot-2026-06-20.md) | evidência V76.39 do piloto estruturado de resultados/dropdown e fallback legado |
...
- Validação local em 2026-08-31, documentada no [relatório do chat mobile](./qa/reports/report-mobile-chat-2026-08-31.md): `appVersion=75.1.0`, `frontendRuntimeVersion=8.6.1`, 337 suítes Jest / 5.724 testes aprovados (sete pulados), 222 testes E2E Chromium e 15 cross-browser. São resultados datados, não contadores automaticamente atualizados.
