...
- linha de trabalho atual: `v76.4` (decomposicao JS controlada, runtime `8.6.1`)
...
| [architecture/repository-structure.md](./architecture/repository-structure.md) | estrutura atual do repositorio pos-V22, reancorada em v76.4 |
...
| [architecture/test-strategy.md](./architecture/test-strategy.md) | estrategia de 172 suites: onde adicionar testes, regras de manutencao *(v16.9.0; contagem v76.4)* |
...
- Estado operacional atual: `appVersion=75.1.0`, `frontendRuntimeVersion=8.6.1`, 172 suites Jest / 3555 testes e 9 specs Playwright / 59 testes listados.
