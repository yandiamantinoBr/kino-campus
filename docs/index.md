...
- linha de trabalho atual: `v76.33` (registro de campos/corpus de busca, runtime frontend `8.6.1` inalterado)
...
- Estado operacional atual: `appVersion=75.1.0`, `frontendRuntimeVersion=8.6.1`, 183 suites Jest / 3682 testes e 10 specs Playwright / 68 testes listados.
