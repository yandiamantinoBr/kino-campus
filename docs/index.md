...
| [architecture/test-strategy.md](./architecture/test-strategy.md) | estratégia de 190 suites: onde adicionar testes, regras de manutenção *(contagem v76.41)* |
...
- Estado operacional atual: `appVersion=75.1.0`, `frontendRuntimeVersion=8.6.1`, 190 suites Jest / 3780 testes e 11 specs Playwright / 74 testes listados.
