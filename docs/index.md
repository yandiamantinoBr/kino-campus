...
- linha de trabalho atual: `v76.39` (piloto estruturado de resultados e dropdown sob duas flags desligadas por padrão, runtime frontend `8.6.1` inalterado)
...
| [architecture/test-strategy.md](./architecture/test-strategy.md) | estratégia de 189 suites: onde adicionar testes, regras de manutenção *(contagem v76.39)* |
...
- Estado operacional atual: `appVersion=75.1.0`, `frontendRuntimeVersion=8.6.1`, 189 suites Jest / 3767 testes e 11 specs Playwright / 70 testes listados.
