...
describe('indicadores de carregamento globais', () => {
  ...
  test('assets de carregamento alterados usam URLs novas apesar do cache immutable', () => {
    ...
    expect(serviceWorker).toContain("var CACHE_VERSION = 'kc-shell-v12.21.4';");
    expect(serviceWorker).toContain("'/assets/css/kc-public-shell.css?v=8.6.16'");
    expect(serviceWorker).toContain("'/assets/css/styles.css?v=8.6.25'");
    expect(serviceWorker).toContain("'/assets/js/core/kc-i18n.js?v=8.6.14'");
