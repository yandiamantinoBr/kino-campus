...
describe('apresentação institucional do KinoCampus', () => {
  ...
  test('é encontrável na home e na página Sobre', () => {
    expect(home).toContain('href="apresentacao-institucional.html"');
    expect(about).toContain('href="apresentacao-institucional.html"');
