...
describe('VERSION.json — integridade', function () {
  ...
  test('campo "branch" é "kinocampus-V21.0-foundations"', function () {
    expect(VERSION.branch).toBe('kinocampus-V21.0-foundations');
  });
...
describe('validate-version-map.js — integridade do script', function () {
  ...
  test('valida branch permanente', function () {
    ...
    expect(SCRIPT).toContain('kinocampus-V21.0-foundations');
  });
