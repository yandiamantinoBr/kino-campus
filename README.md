...
**Status atual:** v11–v14 ENCERRADAS; **v15 em execução** (*JS Root Cleanup — mover 57 arquivos JS para boot/, core/, api/, features/, shared/; branch renomeada para kinocampus-V15.0-foundations*)
