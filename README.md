...
| Fase | Entrega | PRs |
|------|---------|-----|
| v11.2.0 | consistência de shell público: estados ativos da navegação, menu móvel coerente em páginas secundárias e busca mobile adicionada na `create-post.html` | em andamento |
