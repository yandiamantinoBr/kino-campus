...
| Fase | Entrega | PRs |
|------|---------|-----|
| v11.28.0 | auditoria de paridade entre 6 module controllers: 4 gaps mapeados em caronas-feed (sem KCOverlayLock seção + sem SWR) e eventos (sem KCOverlayLock seção + sem SWR); admins sem gaps críticos; plano de correcao v11.28.1 (KCOverlayLock) + v11.28.2 (SWR) em `docs/controller-parity-audit-v11.28.md` | a preencher |
