...
**Status atual:** v11 concluída (v11.1.0–v11.33.7); v12 em execução (*Consolidação & Qualidade Sistêmica*) — `v12.2.2` concluída com terceiro split de `kc-utils.js` (`window._KCU.dom`, 4 funções, −68L, +1 suite 23 testes, 22 HTMLs atualizados); baseline expandida para **102/102 suites · 1977/1977 testes**; próxima iteração: `v12.2.3` (split domínio identity).
