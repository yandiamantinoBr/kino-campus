...
**Status atual:** v11 concluída (v11.1.0–v11.33.7); v12 em execução (*Consolidação & Qualidade Sistêmica*) — `v12.2.3` concluída com quarto split de `kc-utils.js` (`window._KCU.identity`, 5 funções, −11L, +1 suite 29 testes); baseline expandida para **103/103 suites · 2006/2006 testes**; acumulado 2445L → 2231L (−214L); próxima iteração: `v12.2.4` (split domínio taxonomy, ~420L).
