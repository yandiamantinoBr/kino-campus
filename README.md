...
**Status atual:** v11 concluída (v11.1.0–v11.33.7); v12 em execução (*Consolidação & Qualidade Sistêmica*) — `v12.2.0` concluída com primeiro split de `kc-utils.js` (`window._KCU.string`, 8 funções, −65L, +1 suite 29 testes, 22 HTMLs atualizados); baseline expandida para **100/100 suites · 1903/1903 testes**; próxima iteração: `v12.2.1` (split domínio format).
