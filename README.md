...
| Fase | Entrega | PRs |
|------|---------|-----|
| v11.27.2 | fix JS iOS/Safari A3: scroll lock incompleto em `eventos.controller.js` — `openCalModal` e `closeCalModal` migrados de `classList.add/remove('kc-scroll-locked')` no documentElement para `KCOverlayLock.lock/unlock('eventos-cal-modal')`; 2 testes novos — baseline sobe para 59/59 suites e 708/708 testes | a preencher |
