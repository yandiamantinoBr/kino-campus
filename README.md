...
**Status atual:** v11 concluída (v11.1.0–v11.33.7); v12 em execução (*Consolidação & Qualidade Sistêmica*) — `v12.10.0` concluída: **trilha B5 Lighthouse CI** configurada com `.lighthouserc.js` (4 páginas, thresholds warn), `.github/workflows/lighthouse-ci.yml` e `@lhci/cli` devDep; baseline local: index perf/a11y = 74/86, feed = 100/86; Jest 125/125 · 2572/2572 · Playwright 51/51 preservados; próxima iteração: `v12.11.0` (trilha C1 — Service Worker).
