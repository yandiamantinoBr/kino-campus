...
**Status atual:** v11 concluída (v11.1.0–v11.33.7); v12 em execução (*Consolidação & Qualidade Sistêmica*) — `v12.2.1` concluída com segundo split de `kc-utils.js` (`window._KCU.format`, 7 funções, −70L, +1 suite 51 testes, 22 HTMLs atualizados); baseline expandida para **101/101 suites · 1954/1954 testes**; próxima iteração: `v12.2.2` (split domínio dom).
