...
**Status atual:** v11 executada ate `v11.27.0`, com a rodada principal encerrada no release gate `v11.23.0` (regressao verde, hygiene canonico `8.6.0`, smoke remoto e residuals documentados), trilha i18n concluida em `v11.24.x`, baseline de testes elevado para 59/59 suites e 706/706 testes em `v11.26.x` (todos os 7 controllers cobertos) e auditoria iOS/Safari concluida em `v11.27.0` (6 issues mapeados: 3 alta — webkit prefix, font-size zoom, scroll lock; 2 media; 1 baixa — plano de correcao em v11.27.1–v11.27.3).
