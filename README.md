...
**Status atual:** v11 concluída (v11.1.0–v11.33.7); v12 em execução (*Consolidação & Qualidade Sistêmica*) — `v12.9.0` concluída com scaffold Playwright E2E (trilha B4): `playwright.config.js`, `3` suites E2E (`tests/e2e/smoke.spec.js`, `tests/e2e/pages-load.spec.js`, `tests/e2e/a11y-e2e.spec.js`), **18/18 testes E2E verdes**; `@playwright/test` + `http-server` em `devDependencies`; Jest baseline preservada em **125/125 suites · 2572/2572 testes**; próxima iteração: `v12.9.1` (E2E expansão — criar post + comentar + votar).
...
| Testes | Jest: 125 suites de regressão e contrato; Playwright: 3 suites E2E (18 testes) |
