...
**Status atual:** v11 concluída (v11.1.0–v11.33.7); v12 em execução (*Consolidação & Qualidade Sistêmica*) — `v12.2.4` concluída com quinto split de `kc-utils.js` (`window._KCU.taxonomy`, 22 funções, −281L, +1 suite 78 testes); baseline expandida para **104/104 suites · 2084/2084 testes**; acumulado 2445L → 1950L (−495L); próxima iteração: `v12.2.5` (split domínio location, ~30 funções).
